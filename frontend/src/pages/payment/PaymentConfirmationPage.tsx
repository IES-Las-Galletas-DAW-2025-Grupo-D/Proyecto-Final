...
export function PaymentConfirmationPage() {
	...
	useEffect(() => {
		SubscriptionService.getProductPrice();
		if (!sessionId) {
			setState((prev) => ({
				...prev,
				loading: false,
			...
			<div className="min-h-screen bg-base-200 flex items-center justify-center">
				<div className="card w-96 bg-base-100 shadow-xl">
					<div className="card-body text-center">
						...
						<p>
							Please wait while we confirm your payment and upgrade your
							account.
						</p>
					</div>
				</div>
							...
							<div className="space-y-2 text-sm">
								<div className="flex justify-between">
									...
									<span className="font-medium">
										{state.sessionDetails.productName}
									</span>
								</div>
								<div className="flex justify-between">
									...
									<span className="font-medium">
										{formatAmount(
											state.sessionDetails.amountTotal,
											state.sessionDetails.currency
										)}
									</span>
								</div>
								<div className="flex justify-between">
									...
									<span className="badge badge-success">
										{state.sessionDetails.paymentStatus}
									</span>
								</div>
								<div className="flex justify-between">
									<span className="text-base-content/70">Customer:</span>
									<span className="font-medium">
										{state.sessionDetails.customerEmail}
									</span>
								</div>
							</div>
						</div>
